...
const separador = (conjunto) => {
    let simbolo = prompt("Digite que simbolo quiere que separe las palabras de la frase");
...
window.alert("A continuacion hara su frase segun el numero de palabras que escogio");
